    ...
    <div class="container">
        ...
        <form class='form' action="./editarCliente.php?id=<?= $usuario->getidusuario() ?>" method="POST">
            <div class="mb-3"><br>
                ...
                <input type="text" value="<?= $usuario->getNome() ?>" name="nome" class="form-control" id="nome" autocomplete="off" required>
            </div>
            <div class="mb-3 d-flex justify-content-between"><br>
                <div class="input">
                    <label for="email" class="form-label">email</label>
                    <input type="text" value="<?= $usuario->getemail() ?>" step="any" name="email" class="form-control" id="email" required>
                </div>
            </div>
            <div class="mb-3 d-flex justify-content-between"><br>
                <div class="input">
                    <label for="endereco" class="form-label">Endereco</label>
                    <input type="text" value="<?= $usuario->getendereco() ?>" step="any" name="endereco" class="form-control" id="endereco" required>
                </div>
            </div>
            <div class="mb-3 d-flex justify-content-between"><br>
                <div class="input">
                    <label for="telefone" class="form-label">Telefone</label>
                    <input type="text" value="<?= $usuario->gettelefone() ?>" step="any" name="telefone" class="form-control" id="telefone" required>
                </div>
            </div>
            <div class="button"><br>
