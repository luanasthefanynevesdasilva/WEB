    ...
    <div class="container">
        ...
        <form class='form' action="./editarseguro.php?id=<?= $seguro->getidseguro() ?>" method="POST">
            <div class="mb-3"><br>
                ...
                <input type="text" value="<?= $seguro->getvalor() ?>" name="valor" class="form-control" id="valor" autocomplete="off" required>
            </div>
            <div class="mb-3 d-flex justify-content-between">
                <div class="input"><br>
                    <label for="datainicio" class="form-label">datainicio</label>
                    <input type="date" value="<?= $seguro->getdatainicio() ?>" step="any" name="datainicio" class="form-control" id="datainicio" required>
                </div>
            </div>
            <div class="mb-3 d-flex justify-content-between">
                <div class="input"><br>
                    <label for="datafinal" class="form-label">datafinal</label>
                    <input type="date" value="<?= $seguro->getdatafinal() ?>" step="any" name="datafinal" class="form-control" id="datafinal" required>
                </div>
            </div>
            <div class="button"><br>
