                ...
                <div class="mb-3 d-flex justify-content-between" id="produto-specs">
                    <div class="input">
                     ...
                     <div class="input" style="width: 25% !important;">
                        ...
                        <input type="text" step="any" min="1" name="pago" class="form-control" id="pago" required>
                    </div><br>
                    <div class="input" style="width: 25% !important;">
                        <label for="diaria" class="form-label">diaria</label>
                        <input type="text" step="any" min="1" name="diaria" class="form-control" id="diaria" required>
                    </div><br>
                    <div class="input" style="width: 25% !important;">
                        <label for="total" class="form-label">total</label>
                        <input type="text" step="any" min="1" name="total" class="form-control" id="total" required>
                    </div><br>
                    <div class="input" style="width: 25% !important;">
                        <label for="troco" class="form-label">troco</label>
                        <input type="text" step="any" min="1" name="troco" class="form-control" id="troco" required>
                    </div><br>
                    <div class="input" style="width: 25% !important;">
                        <label for="desconto" class="form-label">desconto</label>
                        <input type="text" step="any" min="1" name="desconto" class="form-control" id="desconto" required>
                    </div><br>
                    <div class="input" style="width: 25% !important;">
                        <label for="datalocacao" class="form-label">datalocacao</label>
                        <input type="date" step="any" min="1" name="datalocacao" class="form-control" id="datalocacao" required>
                    </div><br>
                    <div class="input" style="width: 25% !important;">
                        <label for="combustivelatual" class="form-label">combustivelatual</label>
                        <input type="text" step="any" min="1" name="combustivelatual" class="form-control" id="combustivelatual" required>
                    </div>
                </div>
            </div>
            <div class="button"><br>
