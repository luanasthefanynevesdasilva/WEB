    ...
    <div class="container">
        ...
        <div class="mb-3 d-flex justify-content-between">
                <div class="input"><br>
                    ...
                    <input type="number" step="any" name="valor" class="form-control" id="valor" required>
                </div>
            </div>
            <div class="mb-3 d-flex justify-content-between">
                <div class="input"><br>
                    <label for="datainicio" class="form-label">Data-inicio</label>
                    <input type="date" step="any" name="datainicio" class="form-control" id="datainicio" min = 2021-07-09 required>
                </div><br>
            </div>
                        <div class="mb-3 d-flex justify-content-between">
                <div class="input"><br>
                    <label for="datafinal" class="form-label">Data-final</label>
                    <input type="date" step="any" name="datafinal" class="form-control" id="datafinal" min = 2021-07-09  required>
                </div><br>
            </div>
