...
<body>
  ...
  <div id="area-produto"><br>
            ...
            <div class="input" style="width: 25% !important;"><br>
                        ...
                        <input type="text" pattern="[a-z\s]+$" / \ title="sem numero"  step="any" min="4" name="tipoveiculo" class="form-control" id="tipoveiculo" required>
                    </div>
                     <div class="input" style="width: 25% !important;"><br>
                        <label for="ano" class="form-label">ano</label>
                        <input type="number" step="any" min="2000"  max ="2021" name="ano" class="form-control" id="ano" required>
                    </div>
                    <div class="input" style="width: 25% !important;"><br>
                    ...
                    <div class="input" style="width: 25% !important;"><br>
                        ...
                        <input type="text"  pattern="[a-z\s]+$" / \ title="sem numero"  step="any" min="1" name="modelo" class="form-control" id="modelo" required>
                    </div>
                        </div>
                </div>
